...
const (
	...
	SnoGroupSeason                SnoGroup = 137
	SnoGroupHairStyle             SnoGroup = 138
	SnoGroupFacialHair            SnoGroup = 139
	SnoGroupFace                  SnoGroup = 140
	SnoGroupMercenaryClass        SnoGroup = 141
	SnoGroupPassivePowerContainer SnoGroup = 142
	SnoGroupMountProfile          SnoGroup = 143
	SnoGroupAICoordinator         SnoGroup = 144
	SnoGroupCrafterTab            SnoGroup = 145
	SnoGroupTownPortalCosmetic    SnoGroup = 146
	SnoGroupAxeTest               SnoGroup = 147
	SnoGroupWizard                SnoGroup = 148
	SnoGroupFootstepTable         SnoGroup = 149
	SnoGroupModal                 SnoGroup = 150
	SnoGroupCollectiblePower      SnoGroup = 151
	SnoGroupAppearanceSet         SnoGroup = 152
	SnoGroupPreset                SnoGroup = 153
	MaxSnoGroups                           = 154
)
