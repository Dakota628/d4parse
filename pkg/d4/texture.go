...
var (
	TextureFormats = map[int32]TextureFormat{
		0:  {gl.RGBA8, 4, false},
		7:  {gl.R8, 4, false},
		9:  {gl.COMPRESSED_RGB_S3TC_DXT1_EXT, 8, true},
		10: {gl.COMPRESSED_RGB_S3TC_DXT1_EXT, 8, true},
		12: {gl.COMPRESSED_RGBA_S3TC_DXT5_EXT, 4, true},
		23: {gl.R8, 8, false},
		25: {gl.RGBA16F, 4, false},
		41: {gl.COMPRESSED_RED_RGTC1, 4, true},
		42: {gl.COMPRESSED_RG_RGTC2, 4, true},
		43: {gl.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_ARB, 4, true},
		44: {gl.COMPRESSED_RGBA_BPTC_UNORM_ARB, 4, true},
		45: {gl.RGBA8, 4, false},
		46: {gl.COMPRESSED_RGB_S3TC_DXT1_EXT, 4, true},
		47: {gl.COMPRESSED_RGBA_S3TC_DXT1_EXT, 8, true},
		48: {gl.COMPRESSED_RGBA_S3TC_DXT3_EXT, 4, true},
		49: {gl.COMPRESSED_RGBA_S3TC_DXT5_EXT, 4, true},
		50: {gl.COMPRESSED_RGBA_BPTC_UNORM_ARB, 4, true},
		51: {gl.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_ARB, 4, true},
	}
...
func LoadTexture(def *TextureDefinition, payloadPath string) (image.Image, error) {
	...
	gl.PixelStorei(gl.UNPACK_ALIGNMENT, int32(textureFormat.Alignment))
